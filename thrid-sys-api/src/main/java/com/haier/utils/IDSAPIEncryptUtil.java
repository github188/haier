...
public class IDSAPIEncryptUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(IDSAPIEncryptUtil.class);
	...
	public static String encrypt(String data, String digestAlgorithm,
		...
		System.out.println("base64:"+dataAfterBase64Encode);
		...
		System.out.println("DES:"+dataAfterDESEncode);
