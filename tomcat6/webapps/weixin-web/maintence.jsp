...
<input type="hidden" name="user_id" id="user_id" value="">
	...
	<nav class="mui-bar mui-bar-tab">
		<div style="width:80%;margin:0 auto">    
	    	<button id="add" onclick="addMaintenceData()" type="button" class="mui-btn mui-btn-primary" style="width:100%;background-color: #32beff;border:0">立即提交</button>
	   </div>
	</nav>
					...
					<div id="item1mobile" class="mui-slider-item mui-control-content mui-active">
						<div id="scroll1" class="mui-scroll-wrapper">
							<div class="mui-scroll" style="height:760px;position:absolute;overflow-y :auto;">
								...
								<div style="width:100%;height:100px;padding-left:30px;border-bottom: 1px solid #dcdcdc;overflow: hidden;">
									<div style="width:25%;height:100px;float:left;padding-top:15px;"><span class="triangle">*</span><span class="color1">故障描述</span></div>
									<div style="width:75%;height:100px;float:left;">
										<textarea id="infowrong" class="color2" placeholder="请填写故障描述" style="width:98%;padding:15px 2px 0 2px;margin:0;height:100px;border:0;background: transparent;font-size:14px;"></textarea>
										<input id="wrong-hidden" name="wrong" type="hidden"/>
									</div>
								</div>
								<div style="width:100%;height:50px;border-bottom: 1px solid #dcdcdc;padding-left:30px;">
								...
								<div style="width:100%;height:50px;padding-left:30px;">
									...
									<div style="width:75%;height:50px;float: left;border-bottom: 1px solid #dcdcdc;padding-right:32px;">
										<div id="Address" class="color2" style="background:url(images/arrow-down.png) right center no-repeat;background-size:12px 6px;border:0;line-height:50px;width:100%;height:50px;font-size:14px;">请输入</div>
								...
								<div style="width:100%;height:50px;padding-left:30px;">
									...
									<div style="width:30%;height:50px;float: left;border-bottom: 1px solid #dcdcdc;">
										<div id="sheng" class="color3" style="background:url(images/arrow-down.png) right center no-repeat;background-size:12px 6px;border:0;line-height:50px;width:100%;height:50px;padding-left: 5px;">请输入</div>
								...
								<div style="width:100%;height:50px;padding-left:30px;">
									...
									<div style="width:70%;height:50px;float: left;padding-right:30px;border-bottom: 1px solid #dcdcdc;">
										<div id="area" class="color3" style="background:url(images/arrow-down.png) right center no-repeat;background-size:12px 6px;border:0;line-height:50px;width:100%;height:50px;padding-left: 5px;">请输入</div>
								...
								<div style="width:100%;height:50px;padding-left:30px;border-bottom: 1px solid #dcdcdc;">
									...
									<div style="width:75%;height:50px;float:left;">
										<input type="text" id="infoaddress" class="color2" placeholder="请填写详细地址" style="padding:0;margin:0;line-height:50px;height:50px;border:0;background: transparent;font-size:14px;"/>
						...
						<div id="scroll2" class="mui-scroll-wrapper">
							<div class="mui-scroll" style="height:760px;position:absolute;overflow-y :auto;">
								...
								<div style="width:100%;height:40px;border-bottom: 1px solid #dcdcdc;padding-left:30px;">
									...
									<div style="width:75%;height:40px;float: left;padding-right:30px">
										<div id="yjbz-phone" class="color2" style="background:url(images/arrow-down.png) right center no-repeat;background-size:12px 6px;border:0;line-height:40px;width:100%;height:40px;font-size:14px;">请输入</div>
