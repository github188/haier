		...
		<div class="mui-content">
			...
			<form class="mui-input-group" id="formRegister">				
				<div class="mui-input-row" style="height: 86px;line-height:86px;">
					...
					<input id='phone' name="phone" type="number" class="mui-input-clear mui-input" placeholder="请输入手机号" style="margin-top:23px;">
				</div>             	
				
				<div class="mui-input-row" style="height: 86px;line-height:86px;">
					<label style="margin-top:13px;"><img src="images/login/checkcode.png" style="width:40px;height:40px;"></label>
					<input id='checkcode' name="checkcode" type="text" class="mui-input-clear mui-input" placeholder="" style="margin-top:23px;width:46%;float: left;border:1px;">
					<div style="width:32%;height:40px;float: right;padding:23px 10px 0 0">
