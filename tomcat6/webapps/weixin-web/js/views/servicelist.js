			...
			var code = typeof data.code != 'undefined' ? data.code : '';
	   		if(code.toString() == '0') {
	   			...
	   			$.each( data.messages, function(i, n){
					...
					html += '		<div class="detaillink"><a href="service_tree.jsp?order_code='+encodeURI(n.order_code)+'&address='+encodeURI(n.address)+'&contact_name='+encodeURI(n.contact_name)+'&mobile_phone='+encodeURI(n.mobile_phone)+'&product_name='+encodeURI(n.product_name)+'&type_name='+encodeURI(n.type_name)+'&service_time='+encodeURI(n.service_time)+'&statusDesc='+encodeURI(n.statusDesc)+'&require_service_desc='+encodeURI(n.require_service_desc)+'">追踪</a></div>';
					html += '		<div class="service-item clearfix">';
					html += '			<div class="service-content-pic"><img src="images/service/product.png"></div>';
					...
					html += '				<div class="man clearfix">服务兵：'+n.contact_name+'</div>';
					html += '				<div class="man">';
					html += '					<div class="service-content-text-lxr">电话：'+n.mobile_phone+'</div>';
					html += '					<a name="service-icon-phone" href=""><img src="images/service/phone.png"></a>';
					html += '				</div>';
